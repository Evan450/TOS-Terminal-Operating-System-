...
return {
  ...
  hashes = {
    ["/usr/modules/calc/init.lua"] = "4def8a63fd22690a8bdc97e07348b330838d39ec2ae5bf309bd06a3a29253a65",
    ["/usr/modules/calc/sheet.lua"] = "6d9b9e20109f08b53ef83cc9389c122cc6848a97663b070762c6e0b7dbea956b",
  },
  name        = "calc",
  version     = "1.0.0",
  kind        = "command",
